  ...
  return <div className="app-shell">
    ...
    <main className="page-container device-page">
      ...
      <section className="device-grid">
        ...
        <div className="panel panel-pad">
          <div className="section-heading"><h2>Phase 2 model</h2><p>{model ? `${model.model_version} · ${model.prediction_offsets_seconds.length === 0 ? 'recurring 5/10-minute checks' : `${model.prediction_offsets_seconds[0] / 60} minute checkpoint`}` : 'No valid checkpoint model installed. Automatic alerts are disabled.'}</p></div>
